...
-- Dumping data for table pos_salsa.item_penjualan: ~0 rows (approximately)
...
INSERT INTO `jenis` (`id`, `nama_jenis`, `created_at`, `updated_at`) VALUES
	(1, 'Makeup', '2026-09-10 21:21:05', '2026-09-10 21:21:05');
...
-- Dumping data for table pos_salsa.migrations: ~8 rows (approximately)
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES
	...
	(9, '2026_09_09_060338_add_payment_fields_to_penjualans_table', 2),
	(10, '2026_09_11_030313_add_jenis_id_to_produk_table', 2);
...
-- Dumping data for table pos_salsa.penjualan: ~0 rows (approximately)
INSERT INTO `penjualan` (`id`, `user_id`, `total_pembayaran`, `metode_pembayaran`, `uang_masuk`, `kembalian`, `status`, `created_at`, `updated_at`) VALUES
	(1, 2, 0, 'CASH', NULL, NULL, 'OPEN', '2026-08-31 19:55:46', '2026-08-31 19:55:46'),
	(2, 6, 0, 'CASH', NULL, NULL, 'OPEN', '2026-09-10 23:59:21', '2026-09-10 23:59:21');
...
-- Dumping data for table pos_salsa.produk: ~0 rows (approximately)
INSERT INTO `produk` (`id`, `user_id`, `jenis_id`, `foto`, `nama`, `harga_beli`, `harga_jual`, `stok`, `created_at`, `updated_at`) VALUES
	(1, 6, 1, 'products/nHrGVoFlWqMMdeNd3o2UNH7oKLzh7zsniS7MEH2i.jpg', 'Cushion', 80000, 88000, 100, '2026-09-10 21:23:43', '2026-09-10 23:26:53'),
	(2, 6, 1, 'products/ePCuXwpOgqwoqjj7OgkHkTUvVrKORJy5bansw8b8.jpg', 'Lipstik', 30000, 35000, 100, '2026-09-10 21:26:44', '2026-09-10 23:26:42'),
	(3, 6, 1, 'products/ACPPj8KN3h5muQPIVHm0OH43hUnAof2oMubs9wl7.jpg', 'Blus On', 35000, 37000, 100, '2026-09-10 21:27:15', '2026-09-10 23:26:28'),
	(4, 6, 1, 'products/sYWoDkqMhruQ0PmJbTpd7hyxZ96yG5UzoXwIggJD.jpg', 'Lip Balm', 35000, 38000, 100, '2026-09-10 21:27:41', '2026-09-10 23:26:12');
...
-- Dumping data for table pos_salsa.sessions: ~0 rows (approximately)
INSERT INTO `sessions` (`id`, `user_id`, `ip_address`, `user_agent`, `payload`, `last_activity`) VALUES
	...
	('YLRqLBzBRxS37UWqO7lSjMuAfege7BsTXG2nmEC5', 6, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '', 1789110309);
...
INSERT INTO `users` (`id`, `role_id`, `name`, `email`, `email_verified_at`, `password`, `remember_token`, `created_at`, `updated_at`) VALUES
	...
	(6, 1, 'caca', 'caca@com', '2026-08-31 18:55:16', '$2y$12$nfPBdly/un9xQcXZO2DVGO.w6t6c0dZqWP1d73mkF.2jk/EIFEgIe', 'UfcFmDBC1PU0gU5KtJ51KKncINH8hnBK4TD9CM5qxMJQ6tFxSBRB4sjBKq6D', '2026-08-31 18:55:16', '2026-08-31 18:55:16');
